...
Une petite app web pour suivre des intolérances/sensibilités alimentaires : aliments et recettes, symptômes personnalisables, agenda quotidien, classement par symptôme, carnet de recettes séparé — le tout **100 % local, sans compte, sans serveur, sans réseau**.
...
- **Paramètres** : mode sombre, impression/PDF, protection par mot de passe (chiffrement AES-GCM), export/import de sauvegarde, gestion des symptômes
